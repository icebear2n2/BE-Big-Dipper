package com.icebear2n2.bigdipper.user.service;

import com.icebear2n2.bigdipper.domain.entity.AuthCode;
...
import com.icebear2n2.bigdipper.domain.request.PasswordRecoveryRequest;
...
public class PasswordRecoveryService {
    ...
    public void requestPasswordRecovery(UserIdRequest userIdRequest) {
        User user = userRepository.findById(userIdRequest.getUserId()).orElseThrow(() -> new RuntimeException("User not found."));
        // 인증 코드 SMS 전송
        authCodeService.sendAuthCode(new PhoneRequest(userIdRequest.getUserId(), user.getUserPhone()));
    }
